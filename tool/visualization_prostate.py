...
strs = '../../../Daily_Research/TMI_constraint/PaperResults/visualization/prostate_val'
strs1 = '../../../Daily_Research/TMI_constraint/PaperResults/visualization/ProstateDK_0.25_seed12'

patients = ['04', '16', '21', '28', '31', '35', '41', '43']
for i in range(len(patients)):
    ...
    vat1 = f'{strs1}/vat_305reg_run1/iter100/predictions/{patients[i]}'
    vat2 = f'{strs1}/vat_305reg_run2/iter100/predictions/{patients[i]}'
    ...
    cavat1 = f'{strs1}/cavatcons_305reg01eps_507cons_run1/iter099/predictions/{patients[i]}'
    cavat2 = f'{strs1}/cavatcons_305reg01eps_507cons_run2/iter099/predictions/{patients[i]}'
    cavat3 = f'{strs1}/cavatcons_305reg01eps_507cons_run3/iter099/predictions/{patients[i]}'
