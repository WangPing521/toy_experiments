...
if __name__ == "__main__":
    ...
    distribution = input.softmax(1)
    binary_map = distribution.max(1)[1]
    binary_map = binary_map.squeeze(0).numpy()
    print(binary_map)
    pairs, max_labels = group_pairs(binary_map)
    num_componets = equalgroup(pairs, max_labels)
    print(num_componets)
