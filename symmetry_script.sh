...
#lower_baseline
"python -O toySeg_cons.py seed=123 lr=0.005   weight_epoch=100 ratio=0.1 save_dir=${save_dir}/symmetry_lower_205lr"
"python -O toySeg_cons.py seed=123 lr=0.001   weight_epoch=100 ratio=0.1 save_dir=${save_dir}/symmetry_lower_201lr"
